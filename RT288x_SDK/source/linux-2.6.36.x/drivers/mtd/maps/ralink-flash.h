...
#define MTD_UGW_PART_SIZE	0x100000 	//1M
#endif
#endif
...
#define MTD_KERN_PART_SIZE	IMAGE1_SIZE - (MTD_BOOT_PART_SIZE + MTD_CONFIG_PART_SIZE \
					+ MTD_FACTORY_PART_SIZE + MTD_UGW_PART_SIZE)
#endif
...
#else
//#error "nor flash size unknown"
//#define IMAGE1_SIZE		CONFIG_MTD_PHYSMAP_LEN
#define IMAGE1_SIZE 0x800000 //8M
#endif
#endif
