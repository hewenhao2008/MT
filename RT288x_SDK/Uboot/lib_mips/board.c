...
*/
	...
	{
		unsigned long sys_reg_value;

		sys_reg_value = RALINK_REG(0xb0000060);
		if ((sys_reg_value & 0x00100000) == 0x100000)
		{
			sys_reg_value &= (~0x100000);
			RALINK_REG(0xb0000060) = sys_reg_value;
			printf(" GPIO Mode(0x%x)\n", sys_reg_value);
		}
	}

	udelay(1000);
	RALINK_REG(0x10181328) = 0x00000000UL;	//TX_PIN_CFG

	// printf("**************************\n");
	// printf("--- %x %x---\n", RALINK_REG(0x10181328), RALINK_REG(0xb0000060));
	// printf("**************************\n");
